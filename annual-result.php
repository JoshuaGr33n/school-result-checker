...
@media screen {
 ...
 .table-striped > tbody > tr:nth-child(2n+1) > td, .table-striped > tbody > tr:nth-child(2n+1) > th{background-color:	#e9faff}
 .table{
...
.logo2{font-family: Impact, Charcoal, sans-serif; font-size:10px; margin-left:35%; display:block }
...
<div id="container">
                 ...
                 <th   colspan="5"><span class="printText2">First Term</span></th>
								<th   colspan="5"><span class="printText2">Second Term</span></th>
                 <th   colspan="5"><span class="printText2">Third Term</span></th>
                ...
                <tr>
                  <th><span class="printText2">CA1</span></th>
                  <th><span class="printText2">CA2</span></th>
                  <th><span class="printText2">CA3</span></th>
...
<tr>
                ...
                <td><span class="printText"><?php echo  $row_results['FirstTermCA1'];?></span></td>
								<td><span class="printText"><?php echo  $row_results['FirstTermCA2'];?></span></td>
                <td><span class="printText"><?php echo  $row_results['FirstTermCA3'];?></span></td>
                ...
                <td><span class="printText2"><?php echo  $row_results['SecondTermCA1'];?></span></td>
								<td><span class="printText2"><?php echo  $row_results['SecondTermCA2'];?></span></td>
                <td><span class="printText2"><?php echo  $row_results['SecondTermCA3'];?></span></td>
                ...
                <td><span class="printText"><?php echo  $row_results['ThirdTermCA1'];?></span></td>
								<td><span class="printText"><?php echo  $row_results['ThirdTermCA2'];?></span></td>
                <td><span class="printText"><?php echo  $row_results['ThirdTermCA3'];?></span></td>
...
?>
                 ...
                 <td><span class="printText"><?php echo  round($allTotalScoreAverage, 2);?></span></td>
