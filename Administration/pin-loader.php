...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Upload Pin</h1>
          <p></p>
        </div>
      ...
      <form class="form" id="kt_form_1" method="post" name="frmExcelImport" enctype="multipart/form-data" action="pin-loader-suc.php">
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              ...
              <div class="form-group row">
																		...
																		<div class="col-lg-4 col-xl-4">
																			<div class="input-group input-group-lg input-group-solid">
																				...
																				<input type="file" class="form-control form-control-lg form-control-solid" name="file" value="" />
																			</div>
                                                             ...
                                                             <div>
																<input type="submit" name="upload" class="btn btn-sm btn-primary font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-left:25%; width:33%" value="Submit"/>
