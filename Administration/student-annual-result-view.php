...
$student_score=mysqli_query($con, "SELECT SUM(Average) AS Average, StudentID FROM `results` where class ='$_SESSION[annualResultClass]' and school_session = '$_SESSION[annualResultSession]'  GROUP BY StudentID ");
...
//total average
        ...
        $Query = "SELECT StudentReg, SUM(Average) AS totalaverage FROM results WHERE Class ='$_SESSION[annualResultClass]' AND school_session ='$_SESSION[annualResultSession]'  AND StudentReg ='".$regNum."'
