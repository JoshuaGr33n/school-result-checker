          ...
          <div class="tile">
            <div class="tile-body">
              <div class="table-responsive">
																...
																<input type="submit" name="generate_pin" class="btn btn-sm btn-primary font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-left:25%; width:33%" value="Generate Pins"/>
