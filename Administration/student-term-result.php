...
//search results table
        $searchresultQuery = "SELECT * FROM results where StudentID ='".$_GET['studentID']."' and school_session ='". $_SESSION['classResultSession']."'and class ='". $_SESSION['classResultClass']."'and Term ='".$_SESSION['classResultTerm']."'";
...
$p_remarkQuery = "SELECT * FROM remark WHERE name ='Principal' AND session ='".$_SESSION['classResultSession']."' AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."' AND StudentID='".$student_id."'";
...
//total average
        ...
        $Query = "SELECT StudentReg, SUM(Total) AS TotalTotal, SUM(Average) AS totalaverage FROM results WHERE Class ='".$_SESSION['classResultClass']."' AND school_session ='".$_SESSION['classResultSession']."' AND Term ='".$_SESSION['classResultTerm']."' AND StudentReg ='".$regNum."'
...
$totalQuery = "SELECT StudentReg, SUM(Total) AS totalsummation FROM results  WHERE Class ='".$_SESSION['classResultClass']."' AND school_session ='".$_SESSION['classResultSession']."' AND Term ='".$_SESSION['classResultTerm']."' AND StudentReg ='".$regNum."'
...
$student_score=mysqli_query($con, "SELECT SUM(Average) AS Average, StudentID FROM `results` WHERE Class ='".$_SESSION['classResultClass']."' AND school_session = '".$_SESSION['classResultSession']."' AND Term = '".$_SESSION['classResultTerm']."' GROUP BY StudentID ");
